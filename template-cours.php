   ...
   <div class="container">
    <div class="row">
      ...
      <?php foreach(get_field('service') as $service): ?>
        <div class="col-lg-3 service_links_cols">
            <div class="service_img_contain"> 
              <?= $service['image'] ?>
            </div>
...
<section class="modalites_bloc">        
          <div class="container-fluid">    
            <div class="row">  
              <div class="col-lg-6 modalites_left_bloc">  
                <h2 class="modalites_bloc_1_titre" data-aos="fade-up"  data-aos-duration="2000"><?= get_field('organisons_bloc')['titre'] ?></h2>
                <div class="modalites_bloc_1_desc" data-aos="fade-up"  data-aos-duration="2000"><?= get_field('organisons_bloc')['description'] ?></div>
                
      </div>
            
              <div class="col-lg-6 modalites_right_bloc">
                  <h3 class="modalites_bloc_2_titre"data-aos="fade-up"  data-aos-duration="2000"><?= get_field('organisons_bloc')['titre1'] ?></h3>
                  <div class="modalites_bloc_2_desc"data-aos="fade-up"  data-aos-duration="2000"><?= get_field('organisons_bloc')['description1'] ?></div>
                  <div class="services_btn_contain d-flex mt-5"data-aos="fade-up"  data-aos-duration="2000">
